...
{
    this->sinkAddress = other.sinkAddress;
...
void RoutingMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->sinkAddress);
...
void RoutingMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->sinkAddress);
...
const L3Address& RoutingMessage::getSinkAddress() const
{
    return this->sinkAddress;
}

void RoutingMessage::setSinkAddress(const L3Address& sinkAddress)
{
    handleChange();
    this->sinkAddress = sinkAddress;
}

const L3Address& RoutingMessage::getNodeAddress() const
{
    return this->nodeAddress;
}

void RoutingMessage::setNodeAddress(const L3Address& nodeAddress)
{
    handleChange();
...
int RoutingMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 's' && strcmp(fieldName, "sinkPosition") == 0) return base+4;
    if (fieldName[0] == 's' && strcmp(fieldName, "sinkDistance") == 0) return base+5;
...
const char *RoutingMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::L3Address",    // FIELD_sinkAddress
...
std::string RoutingMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    RoutingMessage *pp = (RoutingMessage *)object; (void)pp;
    switch (field) {
        case FIELD_sinkAddress: return pp->getSinkAddress().str();
...
void *RoutingMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    RoutingMessage *pp = (RoutingMessage *)object; (void)pp;
    switch (field) {
        case FIELD_sinkAddress: return toVoidPtr(&pp->getSinkAddress()); break;
        case FIELD_nodeAddress: return toVoidPtr(&pp->getNodeAddress()); break;
