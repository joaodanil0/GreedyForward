...
class RoutingMessage : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual const L3Address& getSinkAddress() const;
    virtual L3Address& getSinkAddressForUpdate() { handleChange();return const_cast<L3Address&>(const_cast<RoutingMessage*>(this)->getSinkAddress());}
    virtual void setSinkAddress(const L3Address& sinkAddress);
    virtual const L3Address& getNodeAddress() const;
    virtual L3Address& getNodeAddressForUpdate() { handleChange();return const_cast<L3Address&>(const_cast<RoutingMessage*>(this)->getNodeAddress());}
    virtual void setNodeAddress(const L3Address& nodeAddress);
